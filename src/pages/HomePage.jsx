        ...
        <>
            <div class="home-block">
                <div class="home-block-text">
                    ...
                    <h2 style={{ marginTop: '24px' }}>Share successes with your peers and mentors before, during and after workshop events! </h2>
                </div>
                <div class={`home-block-image ${isMobileView ? "mobile-view" : "desktop-view"}`}>
